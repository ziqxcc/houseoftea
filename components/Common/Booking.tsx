...
function Booking() {
  const handleClick = () => {
    const whatsappUrl = `https://www.houseoftea.shop/`;
  ...
  return (
    ...
    style={{
      ...
      <div className="flex flex-col md:flex-row items-left md:items-center justify-center md:justify-between w-[80%] max-w-[1200px] gap-7 text-primary py-[8px] z-10">
        <div>
          {/* <p className="text-primary uppercase">NEED A TABLE ON HOUSE of tea</p> */}
        <h5 className="text-white text-[28px] md:text-[42px]">Booking For Your & Family Members</h5></div>
